...
import { TmuxPollingManager } from "../../../src/features/tmux-subagent/polling-manager"
import type { TrackedSession } from "../../../src/features/tmux-subagent/types"
...
describe("TmuxPollingManager overlap", () => {
  test("skips overlapping pollSessions executions", async () => {
    ...
    const manager = new TmuxPollingManager(
      client as unknown as import("../../../src/tools/delegate-task/types").OpencodeClient,
      sessions,
      async () => {},
    )
