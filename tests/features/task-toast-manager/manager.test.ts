...
type TaskToastManagerClass = typeof import("../../../src/features/task-toast-manager/manager").TaskToastManager
...
describe("TaskToastManager", () => {
  ...
  beforeEach(async () => {
    ...
    const mod = await import("../../../src/features/task-toast-manager/manager")
