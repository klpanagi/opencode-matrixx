...
`
      ...
      // when
      const { discoverSkills } = await import("../../../src/features/opencode-skill-loader/loader")
...
`
      ...
      //#when
      const { discoverProjectAgentsSkills } = await import("../../../src/features/opencode-skill-loader/loader")
      const originalCwd = process.cwd()
      process.chdir(TEST_DIR)
