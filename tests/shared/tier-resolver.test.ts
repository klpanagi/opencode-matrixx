...
let TIER_SPECS: typeof import("../../src/shared/model-tiers").TIER_SPECS
let TIER_NAMES: typeof import("../../src/shared/model-tiers").TIER_NAMES

beforeAll(async () => {
  ;({ resolveTier, parseTierReference } = await import("../../src/shared/tier-resolver"))
  ;({ TIER_SPECS, TIER_NAMES } = await import("../../src/shared/model-tiers"))
})
