...
import type { PendingCall } from "../../../src/hooks/comment-checker/types"
...
describe("comment-checker CLI", () => {
  describe("lazy initialization", () => {
    test("getCommentCheckerPathSync should be lazy and callable", async () => {
      // given
      const cliModule = await import("../../../src/hooks/comment-checker/cli")
      // when
  ...
  describe("runCommentChecker", () => {
    test("returns CheckResult shape without explicit CLI path", async () => {
      // given
      const { runCommentChecker } = await import("../../../src/hooks/comment-checker/cli")
      // when
...
`)
  ...
  describe("processWithCli semaphore", () => {
    test("skips second concurrent processWithCli call", async () => {
      ...
      mock.module("../../../src/hooks/comment-checker/cli", cliMockFactory)
      mock.module("../../../src/hooks/comment-checker/cli.ts", cliMockFactory)
      mock.module(new URL("./cli.ts", import.meta.url).href, cliMockFactory)
      const concurrentRunnerBasePath = new URL("../../../src/hooks/comment-checker/cli-runner.ts", import.meta.url).pathname
    ...
    test("allows second call after first call completes", async () => {
      ...
      mock.module("../../../src/hooks/comment-checker/cli.ts", cliMockFactory)
      mock.module(new URL("./cli.ts", import.meta.url).href, cliMockFactory)
      const sequentialRunnerBasePath = new URL("../../../src/hooks/comment-checker/cli-runner.ts", import.meta.url).pathname
