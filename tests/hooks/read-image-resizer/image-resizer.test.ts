...
type ImageResizerModule = typeof import("../../../src/hooks/read-image-resizer/image-resizer")

async function importFreshImageResizerModule(): Promise<ImageResizerModule> {
  return import(`../../../src/hooks/read-image-resizer/image-resizer?test-${Date.now()}-${Math.random()}`)
}
