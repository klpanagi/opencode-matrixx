...
import * as mouse from "../../src/agents/mouse"
import type { MatrixxConfig } from "../../src/config"
import type { CategoryConfig } from "../../src/config/schema"
import * as builtinCommands from "../../src/features/builtin-commands"
import * as commandLoader from "../../src/features/command-loader"
import * as skillLoader from "../../src/features/opencode-skill-loader"
import * as mcpModule from "../../src/mcp"
import * as shared from "../../src/shared"
import * as connectedProvidersCache from "../../src/shared/connected-providers-cache"
import * as modelResolver from "../../src/shared/model-resolver"
import * as configDir from "../../src/shared/opencode-config-dir"
import * as permissionCompat from "../../src/shared/permission-compat"
import { createConfigHandler, resolveCategoryConfig } from "../../src/plugin-handlers/config-handler"

const realResolveModelWithFallback = require("../../src/shared/model-resolver").resolveModelWithFallback
const realResolveModelPipeline = require("../../src/shared/model-resolution-pipeline").resolveModelPipeline

afterAll(() => {
  mock.module("../../src/shared/model-resolver", () => ({
    ...require("../../src/shared/model-resolver"),
    resolveModelWithFallback: realResolveModelWithFallback,
  }))
  mock.module("../../src/shared/model-resolution-pipeline", () => ({
    ...require("../../src/shared/model-resolution-pipeline"),
    resolveModelPipeline: realResolveModelPipeline,
  }))
  mock.module("../../src/shared", () => ({
    ...require("../../src/shared"),
    resolveModelPipeline: realResolveModelPipeline,
  }))
})
