...
mock.module("../../../src/tools/session-manager/constants", () => ({
...
const storage = await import("../../../src/tools/session-manager/storage")
...
describe("session-manager storage - SDK path (beta mode)", () => {
  ...
  test("getMainSessions uses SDK when beta mode is enabled", async () => {
    ...
    const { setStorageClient, getMainSessions } = await import("../../../src/tools/session-manager/storage")
  ...
  test("getAllSessions uses SDK when beta mode is enabled", async () => {
    ...
    const { setStorageClient, getAllSessions } = await import("../../../src/tools/session-manager/storage")
    setStorageClient(mockClient as unknown as Parameters<typeof setStorageClient>[0])
  ...
  test("readSessionMessages uses SDK when beta mode is enabled", async () => {
    ...
    const { setStorageClient, readSessionMessages } = await import("../../../src/tools/session-manager/storage")
    setStorageClient(mockClient as unknown as Parameters<typeof setStorageClient>[0])
  ...
  test("SDK path returns empty array when client is not set", async () => {
    ...
    const { resetStorageClient, readSessionMessages } = await import("../../../src/tools/session-manager/storage")
    resetStorageClient()
    const messages = await readSessionMessages("ses_test")
