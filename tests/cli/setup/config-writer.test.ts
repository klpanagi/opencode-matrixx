...
import { buildMatrixxConfig, previewDiff, resolveMatrixxConfigPath, writeMatrixxConfig } from "../../../src/cli/setup/config-writer";
import type { SetupState } from "../../../src/cli/setup/types";
...
describe("buildMatrixxConfig", () => {
  ...
  test("preserves existing fields", () => {
    const existing = { disabled_hooks: ["comment-checker"] } as unknown as import("../../../src/config/schema/matrixx-config").MatrixxConfig;
