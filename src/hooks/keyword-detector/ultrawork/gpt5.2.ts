...
|----------|-------------|------------|
| explore agent | Need codebase patterns you don't have | \`task(subagent_type="trinity", load_skills=[], run_in_background=true, ...)\` |
| librarian agent | External library docs, OSS examples | \`task(subagent_type="operator", load_skills=[], run_in_background=true, ...)\` |
