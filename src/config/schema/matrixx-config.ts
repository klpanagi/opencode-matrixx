...
export const MatrixxConfigSchema = z.object({
  ...
  /** Predefined model profile: "free" | "budget" | "economy" | "balanced" | "performance" | "go" | "xiaomi-ultimate" | "go-ultimate" | "go-trio". Expanded at config load time; explicit agents/categories override profile defaults. */
  profile: z.enum(["free", "budget", "economy", "balanced", "performance", "go", "xiaomi-ultimate", "go-ultimate", "go-trio"]).optional(),
